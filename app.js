    ...
    cards: [
      {
        polish: "Szpital",
        english: "hospital",
        frontImage: "./images/hospital-front.jpeg",
        backImage: "./images/hospital-back.png",
      },
      {
        polish: "Muzeum",
        english: "museum",
        frontImage: "./images/museum-front.jpg",
        backImage: "./images/museum-back.png",
      },
      {
        polish: "Biblioteka",
        english: "library",
        frontImage: "./images/library-front.png",
        backImage: "./images/library-back.png",
      },
      {
        polish: "Kawiarnia",
        english: "cafe",
        frontImage: "./images/cafe-front.gif",
        backImage: "./images/cafe-back.png",
      },
      {
        polish: "Szkoła",
        english: "school",
        frontImage: "./images/school-front.png",
        backImage: "./images/school-back.png",
      },
      {
        polish: "Supermarket",
        english: "supermarket",
        frontImage: "./images/supermarket-front.jpg",
        backImage: "./images/supermarket-back.png",
      },
      {
        polish: "Basen",
        english: "swimming pool",
        frontImage: "./images/swimmingpool-front.webp",
        backImage: "./images/swimmingpool-back.png",
      },
      {
        polish: "Sklep z zabawkami",
        english: "toy shop",
        frontImage: "./images/toyshop-front.jpg",
        backImage: "./images/toyshop-back.png",
      },
      {
        polish: "Restauracja",
        english: "restaurant",
        frontImage: "./images/restaurant-front.jpg",
        backImage: "./images/restaurant-back.png",
      },
      {
        polish: "Piekarnia",
        english: "bakery",
        frontImage: "./images/bakery-front.gif",
        backImage: "./images/bakery-back.png",
      },
      {
        polish: "Plac zabaw",
        english: "playground",
        frontImage: "./images/playground-front.jpg",
        backImage: "./images/playground-back.png",
      },
      {
        polish: "Księgarnia",
        english: "bookshop",
        frontImage: "./images/bookshop-front.png",
