    ...
    cards: [
      {
        polish: "Szpital",
        english: "hospital",
        frontImage: "./images/hospital-front.webp",
        backImage: "./images/hospital-back.png",
      },
      {
        polish: "Muzeum",
        english: "museum",
        frontImage: "./images/museum-front.webp",
        backImage: "./images/museum-back.png",
      },
      {
        polish: "Biblioteka",
        english: "library",
        frontImage: "./images/library-front.webp",
        backImage: "./images/library-back.png",
      },
      {
        polish: "Kawiarnia",
        english: "cafe",
        frontImage: "./images/cafe-front.webp",
        backImage: "./images/cafe-back.png",
      },
      {
        polish: "Szkoła",
        english: "school",
        frontImage: "./images/school-front.webp",
        backImage: "./images/school-back.png",
      },
      {
        polish: "Supermarket",
        english: "supermarket",
        frontImage: "./images/supermarket-front.webp",
        backImage: "./images/supermarket-back.png",
      },
      {
        polish: "Basen",
        english: "swimming pool",
        frontImage: "./images/swimming-pool-front.webp",
        backImage: "./images/swimming-pool-back.png",
      },
      {
        polish: "Sklep z zabawkami",
        english: "toy shop",
        frontImage: "./images/toy-shop-front.webp",
        backImage: "./images/toy-shop-back.png",
      },
      {
        polish: "Restauracja",
        english: "restaurant",
        frontImage: "./images/restaurant-front.webp",
        backImage: "./images/restaurant-back.png",
      },
      {
        polish: "Piekarnia",
        english: "bakery",
        frontImage: "./images/bakery-front.webp",
        backImage: "./images/bakery-back.png",
      },
      {
        polish: "Plac zabaw",
        english: "playground",
        frontImage: "./images/playground-front.webp",
        backImage: "./images/playground-back.png",
      },
      {
        polish: "Księgarnia",
        english: "bookshop",
        frontImage: "./images/bookshop-front.webp",
        backImage: "./images/bookshop-back.png",
      },
    ],
  },
  digits: {
    id: "digits",
    label: "Liczby",
    albumTitle: "Album: Liczby",
    cards: [
      { polish: "Zero", english: "zero", frontImage: "./images/zero-front.png", backImage: "./images/zero-back.png" },
      { polish: "Jeden", english: "one", frontImage: "./images/jeden-front.png", backImage: "./images/jeden-back.png" },
      { polish: "Dwa", english: "two", frontImage: "./images/dwa-front.png", backImage: "./images/dwa-back.png" },
      { polish: "Trzy", english: "three", frontImage: "./images/trzy-front.png", backImage: "./images/trzy-back.png" },
      { polish: "Cztery", english: "four", frontImage: "./images/cztery-front.png", backImage: "./images/cztery-back.png" },
      { polish: "Pięć", english: "five", frontImage: "./images/piec-front.png", backImage: "./images/piec-back.png" },
      { polish: "Sześć", english: "six", frontImage: "./images/szesc-front.png", backImage: "./images/szesc-back.png" },
      { polish: "Siedem", english: "seven", frontImage: "./images/siedem-front.png", backImage: "./images/siedem-back.png" },
      { polish: "Osiem", english: "eight", frontImage: "./images/osiem-front.png", backImage: "./images/osiem-back.png" },
      { polish: "Dziewięć", english: "nine", frontImage: "./images/dziewiec-front.png", backImage: "./images/dziewiec-back.png" },
      { polish: "Dziesięć", english: "ten", frontImage: "./images/dziesiec-front.png", backImage: "./images/dziesiec-back.png" },
      {
        polish: "Jedenaście",
        english: "eleven",
        frontImage: "./images/jedenascie-front.png",
        backImage: "./images/jedenascie-back.png",
      },
      {
        polish: "Dwanaście",
        english: "twelve",
        frontImage: "./images/dwanascie-front.png",
        backImage: "./images/dwanascie-back.png",
      },
      {
        polish: "Trzynaście",
        english: "thirteen",
        frontImage: "./images/trzynascie-front.png",
        backImage: "./images/trzynascie-back.png",
      },
      {
        polish: "Czternaście",
        english: "fourteen",
        frontImage: "./images/czternascie-front.png",
        backImage: "./images/czternascie-back.png",
      },
      {
        polish: "Piętnaście",
        english: "fifteen",
        frontImage: "./images/pietnascie-front.png",
        backImage: "./images/pietnascie-back.png",
      },
      {
        polish: "Szesnaście",
        english: "sixteen",
        frontImage: "./images/szesnascie-front.png",
        backImage: "./images/szesnascie-back.png",
      },
      {
        polish: "Siedemnaście",
        english: "seventeen",
        frontImage: "./images/siedemnascie-front.png",
        backImage: "./images/siedemnascie-back.png",
      },
      {
        polish: "Osiemnaście",
        english: "eighteen",
        frontImage: "./images/osiemnascie-front.png",
        backImage: "./images/osiemnascie-back.png",
      },
      {
        polish: "Dziewiętnaście",
        english: "nineteen",
        frontImage: "./images/dziewietnascie-front.png",
        backImage: "./images/dziewietnascie-back.png",
      },
      {
        polish: "Dwadzieścia",
        english: "twenty",
        frontImage: "./images/dwadziescia-front.png",
        backImage: "./images/dwadziescia-back.png",
      },
    ],
  },
};
